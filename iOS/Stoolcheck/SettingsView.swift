...
struct SettingsView: View {
    ...
    @AppStorage("stoolcheck_notifyEnabled") private var notifyEnabled = true
    @AppStorage("stoolcheck_reminderEnabled") private var reminderEnabled = false
            ...
            Form {
                ...
                Section("Subscription") {
                    if purchases.isPro {
                        ...
                        Text("Free plan — up to \(StoolcheckStore.freeEntryLimit) entries")
                    }
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/stoolcheck-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/stoolcheck-app/terms.html")!)
                }
            }
